...
```{r makeDebuggingPanelOutput, eval=TRUE, echo=FALSE}
knitr::opts_chunk$set(echo = FALSE)
invisible(require(shinyjs, quietly = T) )
...
#shinyUI(
  div(
    ...
    div(h1("A simple example"),
        ...
        div(style='font-size:larger; font-color:red', strong(em('Toggle ON (and off) the Debugging Panel with control-D.'))),
        pre(
"
